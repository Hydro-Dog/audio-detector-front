...
const MediaSettingsContext = createContext<MediaSettingsContextType>(mediaContextInitialValue);

export const useMediaSettingsContext = () => useContext(MediaSettingsContext);

const FFT_SIZE = 256;
const BYTE_FREQUENCY_DATA_MAX = 256;

// const { audioContext, analyser } = getAudioContext({ fftSize: FFT_SIZE });
export const MediaSettingsContextProvider = ({ children }: PropsWithChildrenOnly) => {
